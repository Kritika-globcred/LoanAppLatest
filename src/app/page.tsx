...
export default function Home() {
  return (
    <div className="flex flex-col items-center"> {/* Removed space-y-16 for more precise margin control */}
      ...
      <section className="w-full bg-card p-6 md:p-8 rounded-lg shadow-lg mx-[5%] mt-[10%] md:mx-[20%] md:mt-[10%]">
        ...
        <p className="text-muted-foreground text-center md:text-left">
          ...
          On tablet and desktop screens, it has a 20% margin from the left and right edges, and now a 10% margin from the top, providing a focused content area.
        </p>
