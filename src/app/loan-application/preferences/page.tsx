...
const globalCountryCodesSample = [
...
export default function PreferencesPage() {
  ...
  const [avekaMessage, setAvekaMessage] = useState("Great! Let's gather some of your study preferences. This will help us tailor the best options for you.");
    ...
    if (storedAcademicData) {
      try {
        ...
        if (gradLevel && (gradLevel === "Degree" || gradLevel === "Diploma" || gradLevel === "Pursuing")) {
          ...
          setCourseLevel("Post-Graduation"); // Auto-select
        } else { // Not applicable or no graduation data
          setCourseLevelOptions(allCourseLevelOptions);
          setDefaultCourseLevel("Graduation");
          setCourseLevel("Graduation"); // Auto-select
        }
      } catch (e) {
      ...
      // No academic data found, show all options
      setCourseLevelOptions(allCourseLevelOptions);
      setDefaultCourseLevel("Graduation");
    }
  }, []);
  ...
  const handleSaveAndContinue = () => {
    if (!preferredCountry1 || !courseLevel) {
      toast({
        title: "Missing Information",
        description: "Please select Preferred Country 1 and Course Level.",
        variant: "destructive",
      });
      return;
    }
    ...
    const preferencesData = {
      preferredCountry1,
      preferredCountry2: preferredCountry2 || null, // Store null if not selected
      courseLevel,
    };
    ...
    router.push('/loan-application/final-summary'); // Navigate to next step
  };
                    ...
                    <Select value={preferredCountry1} onValueChange={setPreferredCountry1}>
                      ...
                      <SelectContent className="bg-white text-black">
                        <SelectGroup>
                          ...
                          {globalCountryCodesSample.map((country) => (
